...
import { ClientResponse, CustomerSignin, CustomerSignInResult } from '@commercetools/platform-sdk';
...
export default function loginOperation({
  ...
  async function login<T extends LoginOperation>({
    ...
    const response = await config.sdkFetch<ClientResponse<CustomerSignInResult>, CustomerSignin>({
      query: "login",
      method: "post",
      body: {
        email,
